...
completed rows. Region is read from Survey Solutions **QD2** (code 1–13, also
EL.. code or Greek name; -97/-99 excluded) and urbanity from **QD3** (codes 3–5
= Αστικά, 1–2 = Αγροτικά/Ημιαστικά). It
